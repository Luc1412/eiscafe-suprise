    ...
    <main>
      ...
      <section className="section-shell pt-28 pb-16 sm:pt-32 sm:pb-24">
        ...
        <div className="legal-copy mt-10 max-w-4xl rounded-[0.5rem] border border-[#efd7dc] bg-white p-6 shadow-sm sm:p-8">
          ...
          <p>
            Die Internetseite der Eiscafe Surprise erfasst mit jedem Aufruf der
            Internetseite durch eine betroffene Person oder ein automatisiertes
            System eine Reihe von allgemeinen Daten und Informationen. Erfasst
            werden können Browsertypen und Versionen, das verwendete
            Betriebssystem, Referrer, aufgerufene Unterseiten, Datum und Uhrzeit
            des Zugriffs, IP-Adresse, Internet-Service-Provider und ähnliche
            Daten zur Gefahrenabwehr.
          </p>
          <p>
            Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die
            Eiscafe Surprise keine Rückschlüsse auf die betroffene Person. Die
            Informationen werden benötigt, um die Inhalte der Internetseite
            korrekt auszuliefern, die dauerhafte Funktionsfähigkeit der Systeme
            zu gewährleisten und im Falle eines Cyberangriffes notwendige
          ...
          <p>
            ...
            sofern dies durch gesetzliche Vorschriften vorgesehen wurde.
          </p>
          ...
          <p>
            ...
            datenschutzrechtlichen Einwilligung. Zur Ausübung dieser Rechte kann
            sich die betroffene Person jederzeit an einen Mitarbeiter des für
            die Verarbeitung Verantwortlichen wenden.
          </p>

          <h3>Google Maps</h3>
          <p>
            Diese Seite bindet zur Darstellung der Anfahrt eine Karte von Google
            Maps ein. Beim Aufruf der Karte können Daten an Google übertragen
            werden. Weitere Informationen zur Verarbeitung durch Google finden
            Sie in den Datenschutzhinweisen von Google.
          </p>

          <h3>Rechtsgrundlage der Verarbeitung</h3>
          <p>
            Art. 6 I lit. a DS-GVO dient unserem Unternehmen als Rechtsgrundlage
            für Verarbeitungsvorgänge, bei denen wir eine Einwilligung einholen.
            Ist die Verarbeitung personenbezogener Daten zur Erfüllung eines
            Vertrags oder zur Durchführung vorvertraglicher Maßnahmen
            erforderlich, beruht die Verarbeitung auf Art. 6 I lit. b DS-GVO.
            Unterliegt unser Unternehmen einer rechtlichen Verpflichtung,
            erfolgt die Verarbeitung auf Grundlage von Art. 6 I lit. c DS-GVO.
            Zur Wahrung berechtigter Interessen kann Art. 6 I lit. f DS-GVO
            Grundlage der Verarbeitung sein.
          </p>
          <p>
            Diese Datenschutzerklärung wurde aus dem Bestandstext der bisherigen
            Website übernommen und für die separate Datenschutzseite gegliedert.
          </p>
        </div>
      </section>
      <SiteFooter />
